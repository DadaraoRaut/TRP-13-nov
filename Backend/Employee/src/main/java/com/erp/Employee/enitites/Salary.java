...
public class Salary {
    ...
    public Salary(String employeeId, String employeeName, String department, String designation,
            String salaryMonth, double basic, double hra, double conveyance, double medical,
            double specialAllowance, double pf, double esi, double tax,
            double grossSalary, double totalDeductions, double netSalary,
            String bankName, String companyName, int effectiveWorkDays,
            LocalDate generatedAt, String companyLocation,String address) {
